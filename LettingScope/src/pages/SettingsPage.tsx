  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle>About PropertyGuard</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="flex items-center gap-2">
            ...
            <p className="text-sm">
              PropertyGuard is a simple, yet powerful application to help you manage your properties,
              utility bills, and reminders. Keep track of all your property-related tasks in one place.
            </p>
          </CardContent>
          <CardFooter className="text-xs text-muted-foreground">
            &copy; 2025 PropertyGuard. All rights reserved.
          </CardFooter>
        </Card>
      </div>
    </div>
